...

  {
    ...
    children: [
      ...
      },
      {
        path: 'death',
        loadChildren: () =>
          import('./death/gmhis-death.module').then(
            (m) => m.GMHISDeathModule
          ),
      },
      {
        path: 'evacuation',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./cash-register-movement/cash-register-movement.module').then((m) => m.CashRegisterMovementModule),
      },
      {
        path: 'cr-activity',
        loadChildren: () =>
