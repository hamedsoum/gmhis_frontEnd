...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: "cash-register-movement",
        loadChildren: () =>
          import("./cash-register-movement/cash-register-movement.module").then(
            (m) => m.CashRegisterMovementModule
          ),
      },
      {
        path: "cr-activity",
        loadChildren: () =>
          import("./cr-activity/cr-activity.module").then(
            (m) => m.CrActivityModule
          ),
      },
      {
        path: "constant",
      ...
      },
      {
        path: "drug",
        loadChildren: () =>
          import("./drug/drug.module").then((m) => m.DrugModule),
      },
      {
        path: "facility",
        loadChildren: () =>
      ...
      },
      {
        path: "medical-folder",
        loadChildren: () =>
          import("./medical-folder/medical-folder.module").then(
